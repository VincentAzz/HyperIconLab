...
import com.capybara.hypericonlab.core.designsystem.liquidglass.miuix.InnerShadow
import com.capybara.hypericonlab.core.designsystem.liquidglass.miuix.innerShadow
import com.capybara.hypericonlab.core.designsystem.liquidglass.miuix.lens
import com.capybara.hypericonlab.core.designsystem.liquidglass.miuix.material3BlurEffect
import com.capybara.hypericonlab.core.designsystem.liquidglass.miuix.rememberCombinedBackdrop
import com.capybara.hypericonlab.core.designsystem.liquidglass.miuix.vibrancy
import com.capybara.hypericonlab.core.designsystem.theme.AppTheme
import com.capybara.hypericonlab.core.designsystem.theme.FloatingBottomBarHeight
import com.capybara.hypericonlab.core.designsystem.theme.FloatingBottomBarIndicatorHeight
import com.capybara.hypericonlab.core.designsystem.theme.FloatingBottomBarIndicatorPadding
        ...
        CompositionLocalProvider(LocalFloatingBottomBarContentColor provides colors.contentColor) {
            Row(
                Modifier
                    ...
                    .padding(FloatingBottomBarIndicatorPadding),
            ...
            CompositionLocalProvider(
                ...
                Row(
                    Modifier
                        ...
                        .height(FloatingBottomBarIndicatorHeight)
                        .padding(horizontal = FloatingBottomBarIndicatorPadding),
                    verticalAlignment = Alignment.CenterVertically,
                ) {
                    content()
                }
                    ...
                    CompositionLocalProvider(LocalFloatingBottomBarContentColor provides colors.activeContentColor) {
                        Row(
                            Modifier
                                ...
                                .requiredWidth(with(density) { (totalWidthPx - (FloatingBottomBarIndicatorPadding * 2).toPx()).toDp() })
                                .height(FloatingBottomBarIndicatorHeight)
                                .graphicsLayer {
                                    val progressOffset = dampedDragAnimation.value * tabWidthPx

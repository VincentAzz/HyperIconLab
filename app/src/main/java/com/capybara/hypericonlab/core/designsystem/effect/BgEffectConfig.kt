// miuix/example/shared/src/commonMain/kotlin/component/effect/BgEffectConfig.kt
...
internal object BgEffectConfig {
    ...
    internal fun get(isDark: Boolean): Config = if (!isDark) OS3_PHONE_LIGHT else OS3_PHONE_DARK
}
